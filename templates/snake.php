              ...
              move: function (time)
              {
                  ...
                  */
                  ...
                  if (hitBody)
                  {
                      ...
                      this.alive = false;
                      var url = "controleur.php?action=upload&score="+currentscore+"&game=1&difficulty=EAS";
                      window.location.replace(url);


                      /*$('#score').val(score);
                      $('#form1').submit();
                      $('#form1').post("controleur.php",
                        {
    ...
    <?php 
        ...
        echo"</div>";
    ?>
    <!--<form id='form1' action="controleur.php" method="POST">
        <input id="score" type="hidden" name="score" values="">
        <input id="game" type="hidden" name="game" values="1">
        <input id="difficulty" type="hidden" name="difficulty" values="EAS">
